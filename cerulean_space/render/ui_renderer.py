...
FUEL_BAR_TEXTURE = Identifier("fuel_bar.png")
...
class UIRenderer(WorldRenderer):
    def __init__(self, world: World, texture_manager: TextureManager, player: PlayerEntity):
        ...
        self.fuel_bar_texture = texture_manager.load_or_get_texture(FUEL_BAR_TEXTURE)
        self.player = player
    ...
    def render(self, game_renderer: GameRenderer):
        ...
        game_renderer.draw_line(x, y,
                                health_bar_width + x, y, 10,
                                Color(255, 0, 0))
